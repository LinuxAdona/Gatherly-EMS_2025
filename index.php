...
<body>
    <div class="min-h-screen font-['Montserrat']">
        ...
        <div class="grid grid-rows-[auto_1fr_auto]">
            <!-- Hero Section -->
            <div class="relative pt-16 overflow-hidden bg-center bg-no-repeat bg-cover hero-section"
                style="background-image: url('public/assets/images/hero-bg.png'); will-change: background-position;"
                data-pan-speed="0.45">
            ...
            <footer class="py-8 bg-gray-800">
                <div class="mx-auto text-center max-w-7xl">
                    <p class="text-sm text-gray-400">© 2025 Gatherly. All rights reserved.</p>
                </div>
            </footer>
        </div>
    </div>
