...
<body>
    <div class="grid grid-rows-[1fr_auto] items-center min-h-screen bg-gray-100 font-['Montserrat']">
        <div class="flex">
            <div class="flex flex-col items-center mt-10 w-1/3">
                <div class="flex flex-col items-start justify-center p-12">
                    <a class="flex flex-col items-start text-2xl font-bold" href="../../index.php">
            ...
            <img src="../../public/assets/images/hero.png" alt="Side Image" class="object-cover w-2/3 h-full">
        </div>
