...
<body>
    <div class="min-h-screen font-['Montserrat']">
        ...
        <nav class="sticky top-0 z-50 w-full shadow-md bg-white/90 backdrop-blur-lg border-b border-gray-200">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-12 md:h-16">
                    <div class="flex items-center h-full">
                        <a href="home.php" class="flex items-center group">
                            <img class="w-8 h-8 sm:w-10 sm:h-10 mr-2 transition-transform group-hover:scale-110"
                ...
                <div id="mobile-menu" class="hidden md:hidden pb-4 space-y-2">
                    ...
                    <a href="#pricing"
                        class="block px-3 py-2 text-sm font-semibold text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-600">Pricing</a>
                    <a href="#contact"
                        class="block px-3 py-2 text-sm font-semibold text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-600">Contact</a>
                </div>
            </div>
        </nav>
        <div class="grid grid-rows-[auto_1fr_auto]">
            <!-- Hero Section -->
            <div id="home"
                class="relative pt-8 sm:pt-12 md:pt-16 overflow-hidden bg-center bg-no-repeat bg-cover hero-section"
                    ...
                    <div class="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-3xl lg:w-full lg:pb-28 xl:pb-32">
                        <main class="mt-6 sm:mt-10 md:mt-16 lg:mt-20 xl:mt-28">
                            <div class="text-center lg:text-left">
                                <h1
                                    class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
                                    <span class="block">Organize Events</span>
                                    <span class="block text-indigo-300">Seamlessly</span>
                                </h1>
                                <p
                                    class="mt-4 sm:mt-5 md:mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-100 max-w-md mx-auto lg:mx-0 leading-relaxed">
                                    Gatherly simplifies event management with powerful tools for planning, promotion,
                                    and attendee engagement.
                                </p>
                                <div
                                    class="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center lg:justify-start">
                                    <a href="signup.php"
            ...
            <div id="features" class="py-12 sm:py-16 md:py-20 bg-gray-50">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col items-center text-center mb-8 sm:mb-12">
                        ...
                        <p class="mt-2 sm:mt-3 text-base sm:text-lg md:text-xl text-gray-600">The smartest way to manage
                            your events</p>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                        <div
                            class="flex flex-col items-center justify-start gap-3 p-6 sm:p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group">
                            <div class="p-4 bg-indigo-100 rounded-xl group-hover:bg-indigo-200 transition-colors">
                                <i class="text-2xl sm:text-3xl text-indigo-600 fa-solid fa-comment-nodes"
                                    aria-hidden="true"></i>
                            </div>
                            <h3 class="mt-2 text-base sm:text-lg font-bold text-gray-800">AI-Powered Matching</h3>
                            <p class="text-xs sm:text-sm text-center text-gray-600 leading-relaxed">Smart
                                recommendations based on your event requirements and preferences</p>
                        </div>
                        <div
                            class="flex flex-col items-center justify-start gap-3 p-6 sm:p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group">
                            <div class="p-4 bg-indigo-100 rounded-xl group-hover:bg-indigo-200 transition-colors">
                                <i class="text-2xl sm:text-3xl text-indigo-600 fa-solid fa-arrow-trend-up"
                                    aria-hidden="true"></i>
                            </div>
                            <h3 class="mt-2 text-base sm:text-lg font-bold text-gray-800">Dynamic Pricing</h3>
                            <p class="text-xs sm:text-sm text-center text-gray-600 leading-relaxed">Get the best rates
                                with real-time pricing based on demand and seasonality</p>
                        </div>
                        <div
                            class="flex flex-col items-center justify-start gap-3 p-6 sm:p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group">
                            <div class="p-4 bg-indigo-100 rounded-xl group-hover:bg-indigo-200 transition-colors">
                                <i class="text-2xl sm:text-3xl text-indigo-600 fa-solid fa-shield-halved"
                                    aria-hidden="true"></i>
                            </div>
                            <h3 class="mt-2 text-base sm:text-lg font-bold text-gray-800">Secure Contracts</h3>
                            <p class="text-xs sm:text-sm text-center text-gray-600 leading-relaxed">Auto-generated
                        ...
                        <div
                            ...
                            <p class="text-xs sm:text-sm text-center text-gray-600 leading-relaxed">Get your event up
            ...
            <div class="relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
                ...
                <div class="relative z-10 mx-auto text-center max-w-4xl px-4 sm:px-6">
                    <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">Ready to
                        Elevate Your Event Management?</h2>
                    <p class="mt-3 sm:mt-4 text-base sm:text-lg md:text-xl font-medium text-indigo-100">Join Gatherly
