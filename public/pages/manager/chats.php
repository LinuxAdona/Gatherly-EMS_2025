    ...
    switch ($action) {
        case 'get_conversations':
            try {
                ...
                $stmt->execute([
                    ':user_id' => $user_id, ':user_id2' => $user_id, ':user_id3' => $user_id,
                    ':user_id4' => $user_id, ':user_id5' => $user_id, ':user_id6' => $user_id,
                    ':user_id7' => $user_id, ':user_id8' => $user_id, ':user_id9' => $user_id
                ]);
        ...
        case 'get_messages':
            try {
                ...
                $params = [
                    ...
                    ':receiver_id2' => $receiver_id, ':user_id2' => $user_id
                ];
...
function markAsRead(senderId) {
    ...
    fetch('', { method: 'POST', body: fd }).catch(e => console.error(e));
}
