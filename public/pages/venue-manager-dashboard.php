...
<body class="bg-linear-to-br from-orange-50 via-white to-red-50 font-['Montserrat']">
    <!-- Navbar -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <div class="hidden md:flex items-center gap-6">
                    <a href="venue-manager-dashboard.php"
                        class="text-orange-600 font-semibold hover:text-orange-700 transition-colors">Dashboard</a>
                    <a href="my-venues.php" class="text-gray-700 hover:text-orange-600 transition-colors">My Venues</a>
                    <a href="bookings-manager.php"
                        class="text-gray-700 hover:text-orange-600 transition-colors">Bookings</a>
                    <a href="pricing-manager.php"
                        class="text-gray-700 hover:text-orange-600 transition-colors">Pricing</a>
                    <a href="analytics-manager.php"
                        class="text-gray-700 hover:text-orange-600 transition-colors">Analytics</a>
                    <div class="relative">
                        <button id="profile-dropdown-btn"
                            class="flex items-center gap-2 text-gray-700 hover:text-orange-600 transition-colors">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Welcome Section -->
        <div class="mb-8">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">Welcome,
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="availability-calendar.php"
