...
define('DB_USER', $_ENV['DB_USERNAME'] ?? getenv('DB_USERNAME') ?: $_SERVER['DB_USERNAME'] ?? 'root');
define('DB_PASS', $_ENV['DB_PASSWORD'] ?? getenv('DB_PASSWORD') ?: $_SERVER['DB_PASSWORD'] ?? '');
define('DB_NAME', $_ENV['DB_DATABASE'] ?? getenv('DB_DATABASE') ?: $_SERVER['DB_DATABASE'] ?? 'gatherly_db');
